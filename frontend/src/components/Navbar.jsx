    ...
    <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
      ...
      <div className="flex items-center gap-4">
        {token ? (
          ...
          <button
            className="bg-primary text-white px-4 py-2 rounded-full font-medium hidden md:block"
            onClick={() => navigate("/login")}
          >
            Create Account
          </button>
        )}
        <img onClick={()=>setShowMenu(true)} src={assets.menu_icon} alt="menu_icon" className="w-6 md:hidden"/>
        {/* mobile--menu */}
